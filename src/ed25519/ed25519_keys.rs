...
use crate::ed25519::{Ed25519Signature, ED25519_PRIVATE_KEY_LENGTH, ED25519_PUBLIC_KEY_LENGTH};
use crate::traits::CryptoMaterialError;
use crate::traits::ValidCryptoMaterialStringExt;
use crate::traits::{
    Genesis, Length, PrivateKey, PublicKey, SigningKey, ValidCryptoMaterial, VerifyingKey,
};
...
impl Ed25519PrivateKey {
    ...
    fn from_bytes_unchecked(bytes: &[u8]) -> Result<Ed25519PrivateKey, CryptoMaterialError> {
    ...
    pub(crate) fn sign_arbitrary_message(&self, message: &[u8]) -> Ed25519Signature {
